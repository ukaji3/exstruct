...
- Evaluation: `bench.cli eval` produces Exact, Normalized, and Raw scores
...
This benchmark reports three evaluation tracks to keep comparisons fair:
...
The evaluator now writes three tracks:
